/*created by prashant shukla, edited by Jay Pandya */
...
function gotPoses(results) {
  if (results.length > 0) {
    ...
    rightWristScrore = results[0].pose.keypoints[10].score;
  }
}
...
function move() {
  ...
  if (pcscore == 4) {
    ...
    text("Press then restart button to play again!", width / 2, height / 2 + 30);
    noLoop();
    pcscore = 0;
  }
